...
# 1. About this Book[¶](about.md#about-this-book "Permalink to this heading")
...
## 1.1. License[¶](about.md#license "Permalink to this heading")

This book is licensed under the terms of the GNU Public License, v2.

## 1.2. Terminology[¶](about.md#terminology "Permalink to this heading")
...
## 1.3. Other References[¶](about.md#other-references "Permalink to this heading")
