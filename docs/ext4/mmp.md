# 3.5. Multiple Mount Protection - The Linux Kernel  documentation
...
# 3.5. Multiple Mount Protection[¶](mmp.md#multiple-mount-protection "Permalink to this heading")
...
| --- | --- | --- | --- |
| 0x0 | \_\_le32 | mmp\_magic | Magic number for MMP, 0x004D4D50 (“MMP”). |
| 0x4 | \_\_le32 | mmp\_seq | Sequence number, updated periodically. |
| 0x8 | \_\_le64 | mmp\_time | Time that the MMP block was last updated. |
| 0x10 | char[64] | mmp\_nodename | Hostname of the node that opened the filesystem. |
| 0x50 | char[32] | mmp\_bdevname | Block device name of the filesystem. |
| 0x70 | \_\_le16 | mmp\_check\_interval | The MMP re-check interval, in seconds. |
