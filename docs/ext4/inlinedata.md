# 2.7. Inline Data — The Linux Kernel  documentation
...
# 2.7. Inline Data[¶](inlinedata.md#inline-data "Permalink to this heading")
...
## 2.7.1. Inline Directories[¶](inlinedata.md#inline-directories "Permalink to this heading")
