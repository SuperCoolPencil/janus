# 2.4. Block and Inode Allocation Policy - The Linux Kernel  documentation
...
# 2.4. Block and Inode Allocation Policy[¶](allocators.md#block-and-inode-allocation-policy "Permalink to this heading")
