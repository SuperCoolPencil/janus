# 2.2. Block Groups — The Linux Kernel  documentation
...
# 2.2. Block Groups[¶](blockgroup.md#block-groups "Permalink to this heading")

## 2.2.1. Layout[¶](blockgroup.md#layout "Permalink to this heading")
...
## 2.2.2. Flexible Block Groups[¶](blockgroup.md#flexible-block-groups "Permalink to this heading")
...
## 2.2.3. Meta Block Groups[¶](blockgroup.md#meta-block-groups "Permalink to this heading")
...
## 2.2.4. Lazy Block Group Initialization[¶](blockgroup.md#lazy-block-group-initialization "Permalink to this heading")
