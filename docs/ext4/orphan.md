# 3.7. Orphan file — The Linux Kernel  documentation
...
# 3.7. Orphan file[¶](orphan.md#orphan-file "Permalink to this heading")
...
(referenced from the superblock through s\_orphan\_file\_inum) with several
blocks. Each of these blocks has a structure:

| Offset | Type | Name | Description |
| --- | --- | --- | --- |
| 0x0 | Array of \_\_le32 entries | Orphan inode entries | Each \_\_le32 entry is either empty (0) or it contains inode number of an orphan inode. |
| blocksize-8 | \_\_le32 | ob\_magic | Magic value stored in orphan block tail (0x0b10ca04) |
