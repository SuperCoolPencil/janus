# 2.6. Bigalloc — The Linux Kernel  documentation
...
# 2.6. Bigalloc[¶](bigalloc.md#bigalloc "Permalink to this heading")
...
The bigalloc feature (EXT4\_FEATURE\_RO\_COMPAT\_BIGALLOC) changes ext4 to
